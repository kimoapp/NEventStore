...
task NuGetPack -depends Package {
	...
	$buildNumberPrerelease = "" #"-build" + $build_number.ToString().PadLeft(5,'0')
	$packageVersion = $version.Major.ToString() + "." + $version.Minor.ToString() + "." + $version.Build.ToString() + $buildNumberPrerelease
